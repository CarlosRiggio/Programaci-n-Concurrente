...
//     if (argc != 6) { // Verificar que se hayan pasado exactamente 5 argumentos más el nombre del programa.
//         printf("El programa debe recibir exactamente 5 argumentos.\n");
//         return 1; // Código de error.
//     }

//     printf("Los argumentos recibidos son:\n");
